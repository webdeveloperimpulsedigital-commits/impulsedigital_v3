export const seoKandivaliData = {
  ...
  "services": {
    "title": "SEO That Works in the Real World",
    "items": [
      {
        "title": "AI SEO",
        "text": [
      ...
      },
      {
        ...
        "text": [
          "For online stores, visibility is everything. We work on making your products easier to find so you’re not losing potential buyers to competitors."
        ]
      },
      {
        "title": "Local SEO",
    ...
    "items": [
      {
        ...
        "text": [
          "Not every business needs a complicated SEO plan. As an SEO company in Kandivali, we focus on what will actually make a difference for you."
        ]
      },
      {
        "title": "Decisions Based on Data (Not Guesswork)",
        "text": [
          "We look at what people are searching for, what your competitors are doing, and where the gaps are, then build from there."
        ]
      }
    ]
  },
    ...
    "items": [
      {
        "title": "",
        "text": [
          "What works for one business might not work for another. So we don’t copy-paste strategies."
        ]
      },
      {
        "title": "Built for How People Search Today",
        "text": [
          "Search behaviour keeps changing. We make sure your website keeps up, whether it’s Google or newer platforms."
        ]
      },
      {
        "title": "Step 1: Understand What’s Happening",
        "text": [
          "We start by looking at your current website, your competitors, and how people are finding (or not finding) you."
        ]
      },
      {
        "title": "Step 2: Plan What Needs to Change",
        "text": [
          "This usually includes a mix of technical fixes, content improvements, and better keyword targeting."
        ]
      },
      {
        "title": "Step 3: Fix and Build",
        "text": [
          "We implement the changes; sometimes, small tweaks make a big difference here."
        ]
      },
      {
        "title": "Step 4: Keep Improving",
        "text": [
          "SEO isn’t something you do once and forget. We keep tracking and adjusting based on what’s working."
        ]
      },
      {
        "title": "What Our SEO Work Includes",
        "text": []
      },
      {
        "title": "Website Audit",
  ...
  "faq": {
    ...
    "items": [
      ...
      },
      {
        ...
        "answer": [
          "We look at rankings, traffic, and most importantly, whether you're getting more inquiries or leads."
        ]
      }
    ]
  }
