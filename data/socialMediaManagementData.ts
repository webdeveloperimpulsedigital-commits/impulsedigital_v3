export const socialMediaManagementData = {
  ...
  "hero": {
    ...
    "description": "worth noticing, remembering, responding to, or sharing. Impulse Digital is the best social media marketing agency in India, combining strategy, content creation, community management, paid amplification, and performance reporting to make your brand more relevant, consistent, and harder to ignore. As a trusted social media marketing company in India with 34 years of marketing experience and a client base that includes Amazon India, HUL, Mastercard, Aditya Birla Group, and Tata Consumer Products, we build social systems that earn attention not just fill a calendar.",
    "buttons": [
      {
  ...
  "channels": {
    ...
    "intro": "Social media management matters when the brand is ready to stop treating content as a monthly quota and that is exactly when choosing the right SMM agency in India makes all the difference.",
    "list": [
  ...
  "faq": {
    ...
    "items": [
      {
        "q": "Why do I need a social media marketing agency in India?",
