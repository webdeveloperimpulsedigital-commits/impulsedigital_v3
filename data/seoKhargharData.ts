export const seoKhargharData = {
  ...
  "whyUs": {
    "title": "Why Businesses in Kharghar Work With Us",
    "items": [
      {
        "title": "We Keep Things Simple",
        "text": [
          "SEO doesn’t need to feel confusing. As an SEO company in Kharghar, we focus on keeping things clear and practical. This helps you understand what’s happening without unnecessary complexity."
        ]
      },
      {
      ...
      },
      {
        ...
        "text": [
          "Every business is unique, and so are the challenges it faces. We adjust the approach based on your goals instead of following a standard template."
        ]
      },
      {
