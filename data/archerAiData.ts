export const archerAiData = {
  ...
  problem: {
    title: "Referrals Close Well. They Scale Poorly.",
    intro: "Warm introductions work because they come with trust.",
    gaps: [],
    outro: [
  ...
  vs: {
    ...
    rightText: "gives you ",
    rightHighlight: "timing, context, and a reason to reach out",
    steps: [
      { num: "01", text: "Find companies showing buying signals" },
      { num: "02", text: "Identify the decision-makers who matter" },
      { num: "03", text: "Build outreach around live market context" },
      { num: "04", text: "Personalise without slowing the system down" },
      { num: "05", text: "Put better conversations in front of your sales team" }
    ],
    ...
    cards: [
      {
        ...
        body: "Find companies that are more likely to have a current need because of what they are doing, changing, hiring, launching, or signalling publicly. Useful when your team needs to stop chasing cold lists and start prioritising accounts with context.",
        outcome: "Output: Signal map, account triggers, opportunity themes, and priority prospect pools."
      },
      {
        title: "Decision-Maker Discovery",
        body: "Identify the people most likely to influence, evaluate, or approve the conversation. Useful when sales teams lose time reaching the wrong titles or staying below the real decision layer.",
        outcome: "Output: Decision-maker lists, role mapping, verified contact data, and account-level outreach paths."
      },
      {
        title: "Personalised Outreach at Scale",
        body: "Turn account intelligence into messages that feel specific, not sprayed across a spreadsheet. Useful when your team needs volume without sounding generic.",
        outcome: "Output: Email sequences, LinkedIn outreach prompts, message angles, and account-specific context."
      },
      {
        title: "Pipeline Learning",
        body: "Track who responds, which segments open conversations, which messages create interest, and where the ICP needs refinement. Useful when outbound needs to improve every cycle instead of running on autopilot.",
        outcome: "Output: Response analysis, segment learning, message performance, ICP refinement, and next-cycle recommendations."
      }
    ]
  },
  process: {
    ...
    steps: [
      ...
      { num: "03", title: "Find the Right People", desc: "We identify and verify the decision-makers who match the account, role, and buying context." },
      { num: "04", title: "Build the Outreach System", desc: "We create personalised message angles, email sequences, LinkedIn prompts, and follow-up logic." },
      { num: "05", title: "Launch, Learn, Improve", desc: "We monitor replies, objections, segments, and conversion signals to refine the engine every cycle." }
    ]
  },
  fit: {
    ...
    list: [
      ...
      "Your referrals work, but they do not create predictable pipeline.",
      "Your buyers are senior, niche, technical, or difficult to identify.",
      "Your offer needs context before someone agrees to a conversation.",
      "Your outbound feels too manual, too generic, or too expensive to scale.",
      "Your next phase of growth needs a system, not just a network."
    ]
  },
  finalCta: {
    headingFontSize: "clamp(3rem, 8.5vw, 8.5rem)",
    titleParts: ["Find Demand Before It Raises Its Hand."],
    accent: "",
  ...
  faq: {
    ...
    items: [
      ...
      { q: "How soon can outreach begin?", a: "The ICP diagnostic and engine build come first. Once the signal map, prospect logic, and messaging system are ready, live outreach can begin." },
