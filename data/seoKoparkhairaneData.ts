export const seoKoparkhairaneData = {
  ...
  "whyUs": {
    "title": "Why Businesses in Koparkhairane Work With Us",
    "items": [
      {
        "title": "We Keep Things Simple",
        "text": [
          "SEO doesn’t need to feel overwhelming. As an SEO company in Koparkhairane, we focus on keeping things clear and practical. This makes it easier for you to understand what’s happening and why."
        ]
      },
      {
        "title": "Decisions Based on Real Data",
        "text": [
          "We rely on actual search trends, competitor insights, and user behaviour. This ensures that efforts are focused on what can actually deliver results."
        ]
      },
      {
        "title": "No Fixed Strategy",
        "text": [
          "The challenges vary from one business to another. We adjust the approach based on your goals instead of using a standard template."
        ]
      },
      {
        "title": "Built for Changing Search Behaviour",
        "text": [
          "Search behaviour keeps evolving over time. We keep refining strategies so your visibility stays stable and continues to improve."
        ]
      }
    ]
  },
