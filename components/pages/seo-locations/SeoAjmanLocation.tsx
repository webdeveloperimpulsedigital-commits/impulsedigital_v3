...
const SeoAjmanLocation: React.FC = () => {
  useEffect(() => {
  ...
  return (
    <main id="main-content">
      ...
      <CaseStudies />
      <Logos title="Trusted by Teams in Ajman & Beyond" />
      <BrandFilm />
      
      <SEOLocationTemplate data={seoAjmanData} />
...
export default SeoAjmanLocation;
