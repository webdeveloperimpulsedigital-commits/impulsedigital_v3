...
import { seoSharjahData } from '@/data/seoSharjahData';

const SeoSharjahLocation: React.FC = () => {
  useEffect(() => {
  ...
  return (
    <main id="main-content">
      ...
      <SEOLocationTemplate data={seoSharjahData} />
...
export default SeoSharjahLocation;
