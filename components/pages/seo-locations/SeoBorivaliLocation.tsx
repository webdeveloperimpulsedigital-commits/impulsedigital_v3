...
const SeoBorivaliLocation: React.FC = () => {
  useEffect(() => {
  ...
  return (
    <main id="main-content">
      ...
      <CaseStudies />
      <Logos title="Trusted by Teams in Borivali & Beyond" />
      <BrandFilm />
      
      <SEOLocationTemplate data={seoBorivaliData} />
...
export default SeoBorivaliLocation;
