...
const SeoBusinessBayLocation: React.FC = () => {
  useEffect(() => {
  ...
  return (
    <main id="main-content">
      ...
      <CaseStudies />
      <Logos title="Trusted by Teams in Business Bay & Beyond" />
      <BrandFilm />
      
      <SEOLocationTemplate data={seoBusinessBayData} />
...
export default SeoBusinessBayLocation;
