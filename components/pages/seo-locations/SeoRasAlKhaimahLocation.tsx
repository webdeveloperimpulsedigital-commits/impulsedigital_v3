...
const SeoRasAlKhaimahLocation: React.FC = () => {
  useEffect(() => {
  ...
  const { hero } = seoRasAlKhaimahData;
  ...
  return (
    <main id="main-content">
      ...
      <CaseStudies />
      <Logos title="Trusted by Teams in Ras Al Khaimah & Beyond" />
      <BrandFilm />
      
      <SEOLocationTemplate data={seoRasAlKhaimahData} />
...
export default SeoRasAlKhaimahLocation;
