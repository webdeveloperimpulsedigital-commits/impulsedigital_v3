...
const SeoSanpadaLocation: React.FC = () => {
  useEffect(() => {
  ...
  return (
    <main id="main-content">
      ...
      <CaseStudies />
      <Logos title="Trusted by Teams in Sanpada & Beyond" />
      <BrandFilm />
      
      <SEOLocationTemplate data={seoSanpadaData} />
...
export default SeoSanpadaLocation;
