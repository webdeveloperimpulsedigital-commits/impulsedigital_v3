...
const SeoFujairahLocation: React.FC = () => {
  useEffect(() => {
  ...
  return (
    <main id="main-content">
      ...
      <CaseStudies />
      <Logos title="Trusted by Teams in Fujairah & Beyond" />
      <BrandFilm />
      
      <SEOLocationTemplate data={seoFujairahData} />
...
export default SeoFujairahLocation;
