...
const SeoMumbaiLocation: React.FC = () => {
  useEffect(() => {
  ...
  return (
    <main id="main-content">
      ...
      <CaseStudies />
      <Logos title="Trusted by Teams in Mumbai & Beyond" />
      <BrandFilm />
      
      <SEOLocationTemplate data={seoMumbaiData} />
...
export default SeoMumbaiLocation;
