...
const SeoDeiraLocation: React.FC = () => {
  useEffect(() => {
  ...
  return (
    <main id="main-content">
      ...
      <CaseStudies />
      <Logos title="Trusted by Teams in Deira & Beyond" />
      <BrandFilm />
      
      <SEOLocationTemplate data={seoDeiraData} />
...
export default SeoDeiraLocation;
