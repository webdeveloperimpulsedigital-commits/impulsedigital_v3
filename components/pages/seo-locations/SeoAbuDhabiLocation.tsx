...
import { seoAbuDhabiData } from '@/data/seoAbuDhabiData';

const SeoAbuDhabiLocation: React.FC = () => {
  useEffect(() => {
  ...
  return (
    <main id="main-content">
      ...
      <SEOLocationTemplate data={seoAbuDhabiData} />
...
export default SeoAbuDhabiLocation;
