    ...
    <main id="main-content">
      ...
      <div className="cs-feature-wrapper">
        <div className="cs-feature-image">
          <img src={`${base}images/case-study-image/tcpl/AUS_us.webp`} alt="TCPL - Impulse Digital Marketing Case Study" fetchPriority="high" decoding="async"  width={600} height={338} />
        </div>
      </div>
