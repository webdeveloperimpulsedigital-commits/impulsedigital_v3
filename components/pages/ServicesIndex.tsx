...
const servicesData = [
  {
    ...
    items: [
      ...
      { title: "Social Intelligence Agency", path: "/growth-intelligence/social-intelligence/", desc: "Continuous monitoring for 24/7 strategic advantage.", image: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&w=800&q=80", span: 1 },
