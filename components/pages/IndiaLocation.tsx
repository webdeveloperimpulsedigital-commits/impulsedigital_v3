...
const locationFaqs = [
  ...
  {
    "question": "What digital marketing services in India does Impulse Digital provide under one engagement? ",
    "answer": "Our digital marketing services in India span three integrated pillars. Growth Intelligence covers Consumer Intelligence, Market and Competitive Intelligence, Always-On Intelligence, and Campaign and Performance Intelligence. AI Marketing Systems covers Archer AI, Agentic AI, AI Video Production, and Generative Search Optimisation. Brand Infrastructure covers Search Engine Optimisation, Social Media Marketing, Video Production, Website Development, Brand Identity, and Employer Branding. You can engage one pillar or all three depending on your current priorities."
  },
  {
    "question": "How is a digital marketing company in India like Impulse Digital different from a generic agency?",
    "answer": "Most agencies execute campaigns. A digital marketing company in India at the level of Impulse Digital builds the intelligence infrastructure behind your campaigns first. Our Consumer Intelligence and Market Intelligence practices map your buyers, your competitors, and your category before a single campaign goes live. Execution follows strategy, not the other way around."
  },
  {
    "question": "How do I choose the best digital marketing company in India for my business?",
    "answer": "Look for three things: documented results from brands comparable to yours, transparent reporting that connects marketing activity to business outcomes, and a team that asks questions before proposing solutions. The best digital marketing company in India will tell you what they cannot do as clearly as what they can. Ask to see case studies with specific traffic, lead, and revenue data before signing anything."
  },
  {
    "question": "How quickly can an enterprise brand in India expect results from a digital marketing programme?",
  ...
  {
    "question": "Which industries does Impulse Digital serve across India?",
...
const IndiaLocation: React.FC = () => {
  ...
  const description = `We help businesses boost their online presence and growth with expert SEO, social media, and paid media strategies. We proudly offer top-tier 360° digital marketing services in India as well as globally. Our dedicated team works as an extension of your brand, helping you uncover your unique voice, refine your messaging, and build genuine connections with your audience. What sets us apart as a leading digital marketing agency in India? It's our ability to combine creativity, strategy, and a client-centric approach to deliver results you can depend on. As a trusted digital marketing company in India with 34 years of marketing experience, we have delivered measurable results for Amazon India, HUL, Mastercard, Tata Consumer Products, Aditya Birla Group, and Himalaya. We bring that same strategic depth to every engagement we take on.`;
