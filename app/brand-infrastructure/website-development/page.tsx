...
export default function WebsiteDevelopmentPage() {
      ...
      const schemas = [
      {
        ...
        "description": "Impulse Digital provides website development services including responsive web design, UI UX design, CMS development, SEO-ready website architecture, landing pages, performance optimisation, and conversion-focused digital experiences.",
        "serviceType": [
          "Website Development",
          "Website Design",
          "UI UX Design",
