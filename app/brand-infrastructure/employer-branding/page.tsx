...
export default function EmployerBrandingPage() {
      ...
      const schemas = [
      {
        ...
        "description": "Impulse Digital provides employer branding services including employer value proposition development, recruitment marketing, internal communication campaigns, culture storytelling, employee engagement content, and talent attraction strategy.",
        "serviceType": [
          "Employer Branding",
          "EVP Development",
