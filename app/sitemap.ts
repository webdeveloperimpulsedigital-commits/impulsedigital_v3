...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes = [
    ...
    // UAE Main Pages
    { url: '/ae/', priority: 1.0, changeFrequency: 'weekly' as const },
    ...
    { url: '/ae/ai-marketing-systems/generative-search-optimisation/', priority: 0.7, changeFrequency: 'monthly' as const },
    ...
    { url: '/ae/brand-infrastructure/employer-branding/', priority: 0.7, changeFrequency: 'monthly' as const },
    { url: '/ae/brand-infrastructure/video-production/', priority: 0.7, changeFrequency: 'monthly' as const },
    // Location pages
