...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes = [
    ...
    { url: '/brand-infrastructure/social-media-marketing/navi-mumbai/', priority: 0.7, changeFrequency: 'monthly' as const, lastModified: SERVICE_PAGES_UPDATED },
    { url: '/brand-infrastructure/social-media-marketing/vashi/', priority: 0.7, changeFrequency: 'monthly' as const, lastModified: SERVICE_PAGES_UPDATED },
    { url: '/brand-infrastructure/social-media-marketing/andheri/', priority: 0.7, changeFrequency: 'monthly' as const, lastModified: SERVICE_PAGES_UPDATED },
    { url: '/brand-infrastructure/social-media-marketing/malad/', priority: 0.7, changeFrequency: 'monthly' as const, lastModified: SERVICE_PAGES_UPDATED },
