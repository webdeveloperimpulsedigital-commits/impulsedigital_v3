  ...
  const schemas = [
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What services does a digital marketing agency in Abu Dhabi like Impulse Digital offer?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Impulse Digital offers a wide range of digital marketing services in Abu Dhabi including Search Engine Optimization (SEO), Social Media Marketing, Website Development, Pay-Per-Click Advertising (PPC), Content Marketing, Branding & Creatives, Employer Branding, and Corporate Communication."
          }
        },
        {
          "@type": "Question",
          "name": "Why choose a digital marketing agency based in Abu Dhabi?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Choosing an Abu Dhabi-based agency ensures you work with experts who understand the local market and consumer behavior. Impulse Digital combines local insights with national and international digital strategies to deliver real results."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "Can Impulse Digital work with clients outside of Abu Dhabi?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, we work with clients across Dubai, Sharjah, and other emirates in the UAE. Our team is equipped to manage projects remotely while maintaining seamless communication and performance tracking."
          }
        },
        {
          "@type": "Question",
