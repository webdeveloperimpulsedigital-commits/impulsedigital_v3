  ...
  const schemas = [
    {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No, one does not need to consider the agency's location, as digital marketing services are provided online and are not restricted to physical presence or areas. Anyone can receive top digital marketing services from Dubai to anywhere in the world. However, it is essential to consider the agency's expertise in your domain, industry alignment, experience, and facilities they provide for online operations."
          }
        },
        {
          "@type": "Question",
