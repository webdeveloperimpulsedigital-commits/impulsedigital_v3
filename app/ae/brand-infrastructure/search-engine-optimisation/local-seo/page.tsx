...
export const metadata: Metadata = {
  title: 'Local SEO Services in Dubai | Impulse Digital',
  description: 'Impulse Digital\'s local SEO services help businesses in Dubai and across UAE rank higher in local search results, Google Maps, and location-based queries.',
  keywords: 'local seo, local seo services, local seo agency dubai',
