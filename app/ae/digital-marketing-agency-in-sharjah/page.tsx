  ...
  const schemas = [
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What does Impulse Digital do for brands in Sharjah?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "As a trusted digital marketing agency in Sharjah, Impulse Digital plans and executes digital marketing strategies that align closely with business goals. Our team blends strategy, creative, media, web, content, and analytics to build strong visibility, meaningful engagement, and consistent conversions."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "Do you work only with brands in Sharjah or across regions as well?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "While we are a digital marketing agency in Sharjah, we partner with clients across the UAE and overseas. Our collaborations are supported through shared workspaces, regular reviews, and clear points of contact to ensure seamless communication and execution across regions."
          }
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "As a digital marketing agency in Sharjah, we start by understanding your objectives, timelines, target markets, and any past reports shared through our contact form. We then set up a discovery call and return with a clear plan that outlines scope, milestones, and measurement."
          }
        }
      ]
    }
