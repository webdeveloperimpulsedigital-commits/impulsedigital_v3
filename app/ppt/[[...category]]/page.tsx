...
const CATEGORY_SEO: Record<string, { title: string; description: string; keywords: string[] }> = {
  'social-media': {
    ...
    keywords: ['social media ppt', 'Mumbai', 'india', 'Impulse digital']
  },
  'content-marketing': {
    ...
    keywords: ['content marketing ppt', 'Mumbai', 'india', 'Impulse digital']
  },
  'employer-branding': {
    ...
    keywords: ['employer branding ppt', 'Mumbai', 'india', 'Impulse digital']
  },
  'google-ads-sem': {
    ...
    keywords: ['google ads ppt', 'SEM PPT', 'Mumbai', 'india', 'Impulse digital']
  },
  'website-design-development': {
    ...
    keywords: ['web design and development ppt', 'Mumbai', 'india', 'Impulse digital']
  }
};
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const keywords = specificSeo?.keywords || (!currentSlug ? ['digital marketing ppt', 'digital marketing powerpoint presentation', 'Mumbai', 'india', 'Impulse digital'] : []);
