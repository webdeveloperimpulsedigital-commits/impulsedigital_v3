...
export default function AIVideoProductionPage() {
      ...
      const schemas = [
      {
        ...
        "description": "Impulse Digital provides AI video production services for brands, including AI-generated videos, product videos, social media videos, campaign films, and scalable visual content for digital marketing.",
        "serviceType": [
          "AI Video Production",
          "AI Generated Videos",
          "Product Videos",
