...
export default function AgenticAIPage() {
      ...
      const schemas = [
      {
        ...
        "description": "Impulse Digital provides Agentic AI services that help businesses automate customer engagement, lead nurturing, follow-ups, workflows, and marketing communication through intelligent AI systems.",
        "serviceType": [
          "Agentic AI",
